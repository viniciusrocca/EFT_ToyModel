...
C     
C     Process: g g > t t~ NP1^2==0 NP2^2==0 NP3^2==0 QCD^2==4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WT)
      ...
      CALL VVV10_11P0_1(W(1,1),W(1,3),GC_10(IVEC),GC_12(IVEC),ZERO,FK_ZE
     $RO,W(1,9))  !  count 2
      CALL VVV10_11P0_1(W(1,1),W(1,4),GC_10(IVEC),GC_12(IVEC),ZERO,FK_ZE
     $RO,W(1,10))  !  count 4
      CALL VVV10_11P0_1(W(1,2),W(1,3),GC_10(IVEC),GC_12(IVEC),ZERO,FK_ZE
     $RO,W(1,11))  !  count 4
      CALL VVV10_11P0_1(W(1,2),W(1,4),GC_10(IVEC),GC_12(IVEC),ZERO,FK_ZE
     $RO,W(1,12))  !  count 2
     ...
     & TMP, W, AMP(1,3))  !  count 1
      ...
      DO K = 1, NCOMB
        ...
        JAMP(:,:) = (0D0,0D0)
C       JAMPs contributing to orders NP1=0 NP3=0 NP2=0 QCD=2
...
C     
      ...
      PARAMETER (NSO=4, NSQUAREDSO=1, NAMPSO=1)
C     
C     ARGUMENTS
C     
...
C     
      ...
      DATA (AMPSPLITORDERS(  1,i),i=  1,  4) /    0,    0,    0,    2/
...
C     
      ...
      PARAMETER (NSO=4, NSQSO=1, NAMPSO=1)
C     
C     ARGUMENTS
C     
      INTEGER ORDERS(NSO)
...
C     
      ...
      DATA (SQSPLITORDERS(  1,i),i=  1,  4) /    0,    0,    0,    4/
