...
C     
C     Process: u u~ > t t~ NP1^2==0 NP2^2==0 NP3^2==0 QCD^2==4 @1
C     Process: c c~ > t t~ NP1^2==0 NP2^2==0 NP3^2==0 QCD^2==4 @1
C     Process: d d~ > t t~ NP1^2==0 NP2^2==0 NP3^2==0 QCD^2==4 @1
C     Process: s s~ > t t~ NP1^2==0 NP2^2==0 NP3^2==0 QCD^2==4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
