...
C     JAMPs contributing to orders NP1=0 NP3=0 NP2=0 QCD=2 QED=0
...
C     
      ...
      PARAMETER (NSO=5, NSQUAREDSO=1, NAMPSO=1)
C     
C     ARGUMENTS
C     
...
C     
      ...
      PARAMETER (NSO=5, NSQSO=1, NAMPSO=1)
C     
C     ARGUMENTS
C     
      INTEGER ORDERS(NSO)
...
C     
      ...
      DATA (SQSPLITORDERS(  1,I),I=  1,  5) /    0,    0,    0,    4, 
     $    0/
