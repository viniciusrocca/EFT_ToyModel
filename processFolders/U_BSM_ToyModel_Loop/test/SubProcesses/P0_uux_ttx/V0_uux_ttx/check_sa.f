...
C       
     ...
     $     //' (NP1=0 NP3=0 NP2=0 QCD=4 QED=0)'
          WRITE (*,*) '---------------------------------'
          WRITE(*,*) '1L) Loop ME for orders (NP1=2 NP3=0 NP2=0 QCD=4'
     $     //' QED=0) :'
          ...
          WRITE(*,*) '2L) Loop ME for orders (NP1=0 NP3=0 NP2=0 QCD=6'
     $     //' QED=0) :'
     ...
     $     ,NSQUAREDSO)
          ...
          WRITE (69,*) 'Split_Orders_Names NP1 NP3 NP2 QCD QED'
          WRITE (69,*) 'Loop_SO_Results 2 0 0 4 0'
