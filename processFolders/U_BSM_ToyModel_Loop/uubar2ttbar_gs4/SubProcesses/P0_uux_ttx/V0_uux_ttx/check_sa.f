...
C       
     ...
     $     //' (NP3=0 NP1=0 NP2=0 QCD=4 QED=0)'
          WRITE (*,*) '---------------------------------'
          WRITE(*,*) '1L) Loop ME for orders (NP3=0 NP1=2 NP2=0 QCD=4'
     $     //' QED=0) :'
          ...
          WRITE(*,*) '2L) Loop ME for orders (NP3=0 NP1=0 NP2=0 QCD=6'
     $     //' QED=0) :'
     ...
     $     ,NSQUAREDSO)
          WRITE (69,*) 'Born_SO_Results 0 0 0 4 0'
          WRITE (69,*) 'SO_Born BORN ',MATELEM(0,1)
          WRITE (69,*) 'Split_Orders_Names NP3 NP1 NP2 QCD QED'
          WRITE (69,*) 'Loop_SO_Results 0 2 0 4 0'
          ...
          WRITE (69,*) 'Loop_SO_Results 0 0 0 6 0'
