...
C     
C     Process: u u~ > t t~ [ all = NP1 NP2 NP3 QCD QED ] NP1^2=2
...
C     
      ...
      DATA (SQPLITORDERS(  1,I),I=  1,  5) /    0,    2,    0,    4,  
     $   0/
...
C     
      ...
      DATA (LOOPAMPORDERS(I),I=  1,  5) /    2,    2,    2,    3,    3/
      ...
      DATA (LOOPAMPORDERS(I),I= 46, 50) /    2,    3,    3,    3,    3/
      DATA (LOOPAMPORDERS(I),I= 51, 55) /    3,    3,    3,    3,    3/
      DATA (LOOPAMPORDERS(I),I= 56, 58) /    3,    3,    3/
C     -----------
C     BEGIN CODE
C     -----------
...
C     
     ...
     $     0/
      DATA (AMPSPLITORDERS(  2,I),I=  1,  5) /    0,    2,    0,    2,
     $     0/
