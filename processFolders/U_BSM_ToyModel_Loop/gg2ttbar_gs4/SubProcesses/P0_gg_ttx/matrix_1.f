...
C     
C     
C     Process: g g > t t~ g [ all = NP1 NP2 NP3 QCD QED ] NP1^2=2
...
C     ----------
      ...
      CALL VVV10_11P0_1(W(1,1),W(1,2),GC_10,GC_12,ZERO,ZERO,W(1,6))
      CALL FFV1P0_3(W(1,4),W(1,3),GC_11,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVV10_11_0(W(1,6),W(1,7),W(1,5),GC_10,GC_12,AMP(1))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL VVV10_11P0_1(W(1,2),W(1,5),GC_10,GC_12,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 9
      ...
      CALL VVV10_11P0_1(W(1,1),W(1,5),GC_10,GC_12,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,4),W(1,12),W(1,6),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,10),W(1,3),W(1,6),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVV10_11_0(W(1,6),W(1,2),W(1,7),GC_10,GC_12,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,9),W(1,12),W(1,1),GC_11,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,10),W(1,8),W(1,1),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVV10_11_0(W(1,1),W(1,11),W(1,7),GC_10,GC_12,AMP(15))
      CALL VVVV1_2P0_1(W(1,1),W(1,2),W(1,5),GC_14,GC_13,ZERO,ZERO,W(1
     $ ,11))
      CALL VVVV1_3P0_1(W(1,1),W(1,2),W(1,5),GC_14,GC_13,ZERO,ZERO,W(1
     $ ,7))
      CALL VVVV2_3P0_1(W(1,1),W(1,2),W(1,5),GC_14,GC_13,ZERO,ZERO,W(1
     $ ,10))
...
C     JAMPs contributing to orders NP1=0 NP3=0 NP2=0 QCD=3 QED=0
...
C     
      ...
      DATA (AMPSPLITORDERS(  1,I),I=  1,  5) /    0,    0,    0,    3,
     $     0/
C     
C     FUNCTION
C     
...
C     the values listed below are for NP1, NP3, NP2, QCD, QED
      DATA (SQSPLITORDERS(  1,I),I=  1,  5) /    0,    0,    0,    6, 
     $    0/
C     
C     BEGIN CODE
C     
