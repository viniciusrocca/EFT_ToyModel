...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WT)
      ...
      CALL VVV2P0_1(W(1,1),W(1,2),GC_10(IVEC),ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_53(IVEC),AMP(1))
...
C     JAMPs contributing to orders NP1=0 QCD=4 QED=0
      JAMP(1,2) = ((0.000000000000000D+00,1.000000000000000D+00))
     $ *AMP(1)
      JAMP(2,2) = ((0.000000000000000D+00,-1.000000000000000D+00))
     $ *AMP(1)
