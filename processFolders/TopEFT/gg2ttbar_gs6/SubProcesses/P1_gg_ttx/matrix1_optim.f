...
C     
C     Process: g g > t t~ NP1^2==0 QCD^2==6 QED^2<=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,3),I=0,4) /14, 1, 1,-1,-1/
      DATA (NHEL(I,4),I=0,4) /15, 1, 1, 1, 1/
      DATA IDEN/256/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WT) 
      ...
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 6
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4))  !  count 6
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5))  !  count 8
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6))  !  count 8
      CALL IXXXXX(P(0,4),MDL_MT,+1,-1*IC(4),W(1,7))  !  count 8
      CALL IXXXXX(P(0,4),MDL_MT,-1,-1*IC(4),W(1,8))  !  count 8
      CALL VVV2P0_1(W(1,1),W(1,3),GC_10(IVEC),ZERO,FK_ZERO,W(1,9))  !  count 2
      CALL VVV2P0_1(W(1,2),W(1,4),GC_10(IVEC),ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_0(W(1,7),W(1,5),W(1,9),GC_53(IVEC),AMP(4,1))
      CALL FFV1_0(W(1,7),W(1,5),W(1,10),GC_53(IVEC),AMP(2,1))
      CALL FFV1_0(W(1,8),W(1,6),W(1,9),GC_53(IVEC),AMP(3,1))
      CALL FFV1_0(W(1,8),W(1,6),W(1,10),GC_53(IVEC),AMP(1,1))  !  count 1
      CALL VVV1P0_1(W(1,1),W(1,3),GC_52(IVEC),ZERO,FK_ZERO,W(1,11))  !  count 2
      CALL VVV1P0_1(W(1,2),W(1,4),GC_52(IVEC),ZERO,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1_0(W(1,7),W(1,5),W(1,11),GC_53(IVEC),AMP(4,2))
      CALL FFV1_0(W(1,7),W(1,5),W(1,12),GC_53(IVEC),AMP(2,2))
      CALL FFV1_0(W(1,8),W(1,6),W(1,11),GC_53(IVEC),AMP(3,2))
      CALL FFV1_0(W(1,8),W(1,6),W(1,12),GC_53(IVEC),AMP(1,2))  !  count 1
      CALL FFV1_1(W(1,5),W(1,1),GC_53(IVEC),MDL_MT,ZERO,W(1,13))  !  count 1
      CALL FFV1_1(W(1,5),W(1,2),GC_53(IVEC),MDL_MT,ZERO,W(1,14))  !  count 1
      CALL FFV1_1(W(1,6),W(1,1),GC_53(IVEC),MDL_MT,ZERO,W(1,15))  !  count 1
      CALL FFV1_1(W(1,6),W(1,2),GC_53(IVEC),MDL_MT,ZERO,W(1,16))  !  count 1
      CALL FFV1_0(W(1,7),W(1,13),W(1,3),GC_53(IVEC),AMP(4,3))
      CALL FFV1_0(W(1,7),W(1,14),W(1,4),GC_53(IVEC),AMP(2,3))
      CALL FFV1_0(W(1,8),W(1,15),W(1,3),GC_53(IVEC),AMP(3,3))
      CALL FFV1_0(W(1,8),W(1,16),W(1,4),GC_53(IVEC),AMP(1,3))  !  count 1
      CALL FFV1_2(W(1,7),W(1,1),GC_53(IVEC),MDL_MT,ZERO,W(1,17))  !  count 1
      CALL FFV1_2(W(1,7),W(1,2),GC_53(IVEC),MDL_MT,ZERO,W(1,18))  !  count 1
      CALL FFV1_2(W(1,8),W(1,1),GC_53(IVEC),MDL_MT,ZERO,W(1,19))  !  count 1
      CALL FFV1_2(W(1,8),W(1,2),GC_53(IVEC),MDL_MT,ZERO,W(1,20))  !  count 1
      CALL FFV1_0(W(1,17),W(1,5),W(1,3),GC_53(IVEC),AMP(4,4))
      CALL FFV1_0(W(1,18),W(1,5),W(1,4),GC_53(IVEC),AMP(2,4))
      CALL FFV1_0(W(1,19),W(1,6),W(1,3),GC_53(IVEC),AMP(3,4))
      CALL FFV1_0(W(1,20),W(1,6),W(1,4),GC_53(IVEC),AMP(1,4))  !  count 1
...
C       JAMPs contributing to orders NP1=0 QCD=2 QED=0
     ...
     $  ( K,2)+(-1.000000000000000D+00)*AMP( K,3)
        JAMP(2,1) = ((0.000000000000000D+00,-1.000000000000000D+00)) *AM
     $  P( K,2)+(-1.000000000000000D+00)*AMP( K,4)
C       JAMPs contributing to orders NP1=0 QCD=4 QED=0
        JAMP(1,2) = ((0.000000000000000D+00,1.000000000000000D+00)) *AMP
     $  ( K,1)
        JAMP(2,2) = ((0.000000000000000D+00,-1.000000000000000D+00)) *AM
     $  P( K,1)
...
C     
      ...
      DATA (AMPSPLITORDERS(  2,i),i=  1,  3) /    0,    4,    0/
...
C     
      ...
      DATA (SQSPLITORDERS(  2,i),i=  1,  3) /    0,    6,    0/
      DATA (SQSPLITORDERS(  3,i),i=  1,  3) /    0,    8,    0/
