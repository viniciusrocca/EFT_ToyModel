...
C     Amplitude(s) for diagram number 1
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_22(IVEC),AMP(1))
      CALL FFFF1_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_23(IVEC),AMP(2))
C     Amplitude(s) for diagram number 2
      CALL FFFF12_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_30(IVEC),AMP(3))
C     Amplitude(s) for diagram number 3
      CALL FFFF10_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_39(IVEC),AMP(4))
C     Amplitude(s) for diagram number 4
      CALL FFFF3_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_26(IVEC),AMP(5))
C     Amplitude(s) for diagram number 5
      CALL FFFF7_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_42(IVEC),AMP(6))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_53(IVEC),ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_53(IVEC),AMP(7))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders NP1=0 NP2=0 QCD=2 QED=0
      JAMP(1,1) = (1.666666666666667D-01)*AMP(7)
      JAMP(2,1) = (-5.000000000000000D-01)*AMP(7)
C     JAMPs contributing to orders NP1=0 NP2=0 QCD=4 QED=0
      JAMP(1,2) = AMP(2)+(-1.666666666666667D-01)*AMP(3)+AMP(6)
      JAMP(2,2) = AMP(1)+(5.000000000000000D-01)*AMP(3)+AMP(4)+AMP(5)
