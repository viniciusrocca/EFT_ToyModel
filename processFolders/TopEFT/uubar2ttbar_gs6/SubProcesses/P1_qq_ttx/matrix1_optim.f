...
C     
C     Process: u u~ > t t~ NP1^2==0 NP2^2==0 QCD^2==6 QED^2<=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WT) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),ZERO,+1,+1*IC(1),W(1,1))  !  count 25
      CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,2))  !  count 25
      CALL OXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 25
      CALL OXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4))  !  count 25
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5))  !  count 28
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6))  !  count 28
      CALL IXXXXX(P(0,4),MDL_MT,+1,-1*IC(4),W(1,7))  !  count 28
      CALL IXXXXX(P(0,4),MDL_MT,-1,-1*IC(4),W(1,8))  !  count 28
      CALL FFFF3P1N_1(W(1,3), W(1,2), W(1,5), GC_22(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFF3P1N_1(W(1,3), W(1,2), W(1,6), GC_22(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFF3P1N_1(W(1,4), W(1,1), W(1,5), GC_22(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFF3P1N_1(W(1,4), W(1,1), W(1,6), GC_22(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFFF1P1N_1(W(1,3), W(1,2), W(1,5), -GC_23(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFF1P1N_1(W(1,3), W(1,2), W(1,6), -GC_23(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFF1P1N_1(W(1,4), W(1,1), W(1,5), -GC_23(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFF1P1N_1(W(1,4), W(1,1), W(1,6), -GC_23(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFFF12P1N_1(W(1,3), W(1,2), W(1,5), -GC_30(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFFF12P1N_1(W(1,3), W(1,2), W(1,6), -GC_30(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFFF12P1N_1(W(1,4), W(1,1), W(1,5), -GC_30(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFFF12P1N_1(W(1,4), W(1,1), W(1,6), -GC_30(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFFF10P1N_1(W(1,3), W(1,2), W(1,5), GC_39(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,4))
      CALL FFFF10P1N_1(W(1,3), W(1,2), W(1,6), GC_39(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,4))
      CALL FFFF10P1N_1(W(1,4), W(1,1), W(1,5), GC_39(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,4))
      CALL FFFF10P1N_1(W(1,4), W(1,1), W(1,6), GC_39(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFFF3P1N_1(W(1,3), W(1,2), W(1,5), GC_26(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))
      CALL FFFF3P1N_1(W(1,3), W(1,2), W(1,6), GC_26(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))
      CALL FFFF3P1N_1(W(1,4), W(1,1), W(1,5), GC_26(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))
      CALL FFFF3P1N_1(W(1,4), W(1,1), W(1,6), GC_26(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))  !  count 1
      CALL FFFF7P1N_1(W(1,3), W(1,2), W(1,5), -GC_42(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,6))
      CALL FFFF7P1N_1(W(1,3), W(1,2), W(1,6), -GC_42(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,6))
      CALL FFFF7P1N_1(W(1,4), W(1,1), W(1,5), -GC_42(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,6))
      CALL FFFF7P1N_1(W(1,4), W(1,1), W(1,6), -GC_42(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_53(IVEC),ZERO,FK_ZERO,W(1,9))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_53(IVEC),ZERO,FK_ZERO,W(1,10))  !  count 4
      CALL FFV1P1N_1(W(1,5), W(1,9), GC_53(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,5), W(1,10), GC_53(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,6), W(1,9), GC_53(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,7))
      CALL FFV1P1N_1(W(1,6), W(1,10), GC_53(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,7))  !  count 1
      ...
      DO K = 1, NCOMB
        ...
        JAMP(:,:) = (0D0,0D0)
C       JAMPs contributing to orders NP1=0 NP2=0 QCD=2 QED=0
        JAMP(1,1) = (1.666666666666667D-01)*AMP( K,7)
        JAMP(2,1) = (-5.000000000000000D-01)*AMP( K,7)
C       JAMPs contributing to orders NP1=0 NP2=0 QCD=4 QED=0
        JAMP(1,2) = AMP( K,2)+(-1.666666666666667D-01)*AMP( K,3)+AMP( K,
     $  6)
        JAMP(2,2) = AMP( K,1)+(5.000000000000000D-01)*AMP( K,3)+AMP( K,4
     $  )+AMP( K,5)
...
C     
      ...
      PARAMETER (NSO=4, NSQUAREDSO=3, NAMPSO=2)
C     
C     ARGUMENTS
C     
...
C     
      ...
      DATA (AMPSPLITORDERS(  1,i),i=  1,  4) /    0,    0,    2,    0/
      DATA (AMPSPLITORDERS(  2,i),i=  1,  4) /    0,    0,    4,    0/
...
C     
      ...
      PARAMETER (NSO=4, NSQSO=3, NAMPSO=2)
C     
C     ARGUMENTS
C     
      INTEGER ORDERS(NSO)
...
C     
      ...
      DATA (SQSPLITORDERS(  1,i),i=  1,  4) /    0,    0,    4,    0/
      DATA (SQSPLITORDERS(  2,i),i=  1,  4) /    0,    0,    6,    0/
      DATA (SQSPLITORDERS(  3,i),i=  1,  4) /    0,    0,    8,    0/
