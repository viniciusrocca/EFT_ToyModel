...
C     Amplitude(s) for diagram number 1
      CALL FFVV1_0(W(1,4),W(1,3),W(1,1),W(1,2),GC_92(IVEC),AMP(1))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_52(IVEC),ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_53(IVEC),AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV7_0(W(1,4),W(1,3),W(1,5),GC_88(IVEC),AMP(3))
      CALL FFV1_1(W(1,3),W(1,1),GC_53(IVEC),MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),GC_53(IVEC),AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV7_0(W(1,4),W(1,5),W(1,2),GC_88(IVEC),AMP(5))
      CALL FFV7_1(W(1,3),W(1,1),GC_88(IVEC),MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),GC_53(IVEC),AMP(6))
      CALL FFV1_2(W(1,4),W(1,1),GC_53(IVEC),MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,5),W(1,3),W(1,2),GC_53(IVEC),AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV7_0(W(1,5),W(1,3),W(1,2),GC_88(IVEC),AMP(8))
      CALL FFV7_2(W(1,4),W(1,1),GC_88(IVEC),MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,5),W(1,3),W(1,2),GC_53(IVEC),AMP(9))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders NP1=0 QCD=2 QED=0
      JAMP(1,1) = ((0.000000000000000D+00,1.000000000000000D+00))
     $ *AMP(2)+(-1.000000000000000D+00)*AMP(4)
      JAMP(2,1) = ((0.000000000000000D+00,-1.000000000000000D+00))
     $ *AMP(2)+(-1.000000000000000D+00)*AMP(7)
C     JAMPs contributing to orders NP1=2 QCD=2 QED=0
      TMP_JAMP(1) = AMP(1) +  AMP(3)  ! used 2 times
      JAMP(1,2) = (-1.000000000000000D+00)*AMP(5)+(-1.000000000000000D
     $ +00)*AMP(6)+((0.000000000000000D+00,1.000000000000000D+00))
     $ *TMP_JAMP(1)
      JAMP(2,2) = (-1.000000000000000D+00)*AMP(8)+(-1.000000000000000D
     $ +00)*AMP(9)+((0.000000000000000D+00,-1.000000000000000D+00))
     $ *TMP_JAMP(1)
