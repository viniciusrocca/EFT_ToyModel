...
C     
C     Process: u u~ > t t~ NP1^2==2 QCD^2==4 QED^2<=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WT) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),ZERO,+1,+1*IC(1),W(1,1))  !  count 13
      CALL IXXXXX(P(0,1),ZERO,-1,+1*IC(1),W(1,2))  !  count 13
      CALL OXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3))  !  count 13
      CALL OXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4))  !  count 13
      CALL OXXXXX(P(0,3),MDL_MT,+1,+1*IC(3),W(1,5))  !  count 20
      CALL OXXXXX(P(0,3),MDL_MT,-1,+1*IC(3),W(1,6))  !  count 20
      CALL IXXXXX(P(0,4),MDL_MT,+1,-1*IC(4),W(1,7))  !  count 20
      CALL IXXXXX(P(0,4),MDL_MT,-1,-1*IC(4),W(1,8))  !  count 20
      CALL FFFF5P1N_1(W(1,3), W(1,2), W(1,5), -GC_31(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFF5P1N_1(W(1,3), W(1,2), W(1,6), -GC_31(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFF5P1N_1(W(1,4), W(1,1), W(1,5), -GC_31(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))
      CALL FFFF5P1N_1(W(1,4), W(1,1), W(1,6), -GC_31(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFFF10P1N_1(W(1,3), W(1,2), W(1,5), GC_45(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFF10P1N_1(W(1,3), W(1,2), W(1,6), GC_45(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFF10P1N_1(W(1,4), W(1,1), W(1,5), GC_45(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))
      CALL FFFF10P1N_1(W(1,4), W(1,1), W(1,6), GC_45(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFFF7P1N_1(W(1,3), W(1,2), W(1,5), -GC_44(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFFF7P1N_1(W(1,3), W(1,2), W(1,6), -GC_44(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFFF7P1N_1(W(1,4), W(1,1), W(1,5), -GC_44(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))
      CALL FFFF7P1N_1(W(1,4), W(1,1), W(1,6), -GC_44(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_53(IVEC),ZERO,FK_ZERO,W(1,9))  !  count 8
      CALL FFV1P0_3(W(1,2),W(1,3),GC_53(IVEC),ZERO,FK_ZERO,W(1,10))  !  count 8
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV7P1N_1(W(1,5), W(1,9), GC_88(IVEC), TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))
      CALL FFV7P1N_1(W(1,5), W(1,10), GC_88(IVEC), TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))
      CALL FFV7P1N_1(W(1,6), W(1,9), GC_88(IVEC), TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/7,8/),
     & TMP, W, AMP(1,5))
      CALL FFV7P1N_1(W(1,6), W(1,10), GC_88(IVEC), TMP(1))
      call CombineAmp(2,
     & (/5,6/), 
     & (/7,8/),
...
C       JAMPs contributing to orders NP1=0 QCD=2 QED=0
        JAMP(1,1) = (1.666666666666667D-01)*AMP( K,4)
        JAMP(2,1) = (-5.000000000000000D-01)*AMP( K,4)
C       JAMPs contributing to orders NP1=2 QCD=2 QED=0
        TMP_JAMP(1) = AMP( K,1) - AMP( K,5)   !  used 2 times
        JAMP(1,2) = AMP( K,3)+(-1.666666666666667D-01)*TMP_JAMP(1)
        JAMP(2,2) = AMP( K,2)+(5.000000000000000D-01)*TMP_JAMP(1)
