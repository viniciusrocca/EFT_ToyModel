...
C     Amplitude(s) for diagram number 1
      CALL FFFF5_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_31(IVEC),AMP(1))
C     Amplitude(s) for diagram number 2
      CALL FFFF10_0(W(1,4),W(1,2),W(1,1),W(1,3),GC_45(IVEC),AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFFF7_0(W(1,4),W(1,2),W(1,1),W(1,3),-GC_44(IVEC),AMP(3))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_53(IVEC),ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_53(IVEC),AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV7_0(W(1,4),W(1,3),W(1,5),GC_88(IVEC),AMP(5))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders NP1=0 QCD=2 QED=0
      JAMP(1,1) = (1.666666666666667D-01)*AMP(4)
      JAMP(2,1) = (-5.000000000000000D-01)*AMP(4)
C     JAMPs contributing to orders NP1=2 QCD=2 QED=0
      TMP_JAMP(1) = AMP(1) - AMP(5)  ! used 2 times
      JAMP(1,2) = AMP(3)+(-1.666666666666667D-01)*TMP_JAMP(1)
      JAMP(2,2) = AMP(2)+(5.000000000000000D-01)*TMP_JAMP(1)
