...
C     
C     Process: g g > t t~ NP1^2==0 QCD^2==4 QED^2<=0 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WT) 
      ...
      CALL VVV1P0_1(W(1,1),W(1,3),GC_52(IVEC),ZERO,FK_ZERO,W(1,9))  !  count 2
      CALL VVV1P0_1(W(1,1),W(1,4),GC_52(IVEC),ZERO,FK_ZERO,W(1,10))  !  count 4
      CALL VVV1P0_1(W(1,2),W(1,3),GC_52(IVEC),ZERO,FK_ZERO,W(1,11))  !  count 4
     ...
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,5),W(1,1),GC_53(IVEC),MDL_MT,ZERO,W(1,13))  !  count 3
      CALL FFV1_1(W(1,5),W(1,2),GC_53(IVEC),MDL_MT,ZERO,W(1,14))  !  count 3
      CALL FFV1_1(W(1,6),W(1,1),GC_53(IVEC),MDL_MT,ZERO,W(1,15))  !  count 3
      CALL FFV1_1(W(1,6),W(1,2),GC_53(IVEC),MDL_MT,ZERO,W(1,16))  !  count 3
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV1_2(W(1,7),W(1,1),GC_53(IVEC),MDL_MT,ZERO,W(1,17))  !  count 3
      CALL FFV1_2(W(1,7),W(1,2),GC_53(IVEC),MDL_MT,ZERO,W(1,18))  !  count 3
      CALL FFV1_2(W(1,8),W(1,1),GC_53(IVEC),MDL_MT,ZERO,W(1,19))  !  count 3
      CALL FFV1_2(W(1,8),W(1,2),GC_53(IVEC),MDL_MT,ZERO,W(1,20))  !  count 3
