...
\begin{itemize}
	...
	\begin{align}
		\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] &=\frac{i}{4} \int \frac{d^d q}{(2\pi)^d}   \tr\left[ \frac{ \slashed{P} (-\slashed{q} +M_T)  }{ q^2 + M_T^2 } \right]\left[ \frac{ \slashed{P} (-\slashed{q} +M_T)  }{ q^2 + M_T^2 } \right]\left[ \frac{ \slashed{P} (-\slashed{q} +M_T)  }{ q^2 + M_T^2 } \right]\left[ \frac{ \slashed{P} (-\slashed{q} +M_T)  }{ q^2 + M_T^2 } \right]\label{eq:B1}
	\end{align}
	...
	\begin{align}
		&\left[\slashed{P} (-\slashed{q} +M_T)\right]^4 \supset \bigg[\gamma^\alpha \gamma_\mu\gamma^\beta\gamma_\nu\gamma^\lambda\gamma_\rho\gamma^\theta\gamma_\sigma\frac{1}{d(d+2)} (g^{\mu\nu}g^{\sigma\rho} + g^{\mu\rho} g^{\nu\sigma} + g^{\mu\sigma} g^{\nu\rho})q^4 \nonumber\\
		&\frac{1}{d}M_T^2 \gamma^\alpha \gamma^\mu\gamma^\beta\gamma_\mu \gamma^\lambda\gamma^\theta q^2 + \frac{1}{d}M_T^2 \gamma^\alpha\gamma^\mu \gamma^\beta\gamma^\lambda\gamma_\mu \gamma^\theta q^2
		+\frac{1}{d}M_T^2 \gamma^\alpha \gamma^\mu \gamma^\beta \gamma^\lambda \gamma^\theta \gamma_\mu q^2\nonumber\\
		&+\frac{1}{d}M_T^2 \gamma^\alpha\gamma^\beta\gamma^\mu\gamma^\lambda\gamma_\mu\gamma^\theta q^2
		+\frac{1}{d}M_T^2 \gamma^\alpha\gamma^\beta\gamma^\mu\gamma^\lambda\gamma^\theta\gamma_\mu q^2
		+ \frac{1}{d}M_T^2 \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\mu\gamma^\theta\gamma_\mu q^2 + M_T^4 \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\theta
		\bigg]P_\alpha P_\beta P_\lambda P_\theta
	\end{align}
	
	When substituting this back into Eq. (\ref{eq:B1}), terms proportional to $q^4$, $q^2$ and $1$ will give raise to $\tilde{\lf}^{4,-2}_T$, $\tilde{\lf}^{4,-1}_T$ and $\tilde{\lf}^{4,0}_T$, respectively. Furthermore, we know that only $\tilde{\lf}^{4,-2}_T$ has a divergent contribution. Therefore, we only need to keep tracking of the dimension $d$ in terms proportional to $q^4$, since it is possible that $\mathcal{O}(\epsilon)$ contribution cancel the pole $\frac{1}{\epsilon}$. For the other terms we can set $d=4$:
	...
	We know that Dirac matrices obey the following identities:
	...
	Since we only need to keep track of $\epsilon$ in the terms proportional to $q^4$:
	
	
	
	\begin{align}
		&\left[\slashed{P} (-\slashed{q} +M_T)\right]^4 \supset \bigg[\frac{1}{(24 - 10\epsilon)}\gamma^\alpha \gamma^\nu\gamma^\beta\gamma_\nu\gamma^\lambda\gamma^\sigma\gamma^\theta\gamma_\sigma q^4
		+\frac{1}{(24 - 10\epsilon)} \gamma^\alpha \gamma^\mu\gamma^\beta\gamma^\nu\gamma^\lambda\gamma_\mu\gamma^\theta\gamma_\nu q^4
		\nonumber\\
	...
	\noindent where we are discarding contributions $\mathcal{O}(\epsilon^2)$.                                           
	
	\begin{align}
		&\left[\slashed{P} (-\slashed{q} +M_T)\right]^4 \supset \bigg[\frac{4(1-\epsilon)}{(24 - 10\epsilon)}\gamma^\alpha \gamma^\beta\gamma^\lambda\gamma^\theta q^4
		-\frac{2}{(24 - 10\epsilon)} \gamma^\alpha \gamma^\mu\gamma^\beta\gamma^\theta\gamma_\mu\gamma^\lambda q^4 + \frac{\epsilon}{(24 - 10\epsilon)}\gamma^\alpha \gamma^\mu\gamma^\beta\gamma^\lambda\gamma_\mu\gamma^\theta q^4
		\nonumber\\ &+ \frac{(-2 + \epsilon)}{(24 - 10\epsilon)}\gamma^\alpha \gamma^\mu\gamma^\beta\gamma^\lambda\gamma^\theta\gamma_\mu q^4 \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\beta \gamma^\lambda\gamma^\theta  q^2 + M_T^2g^{\beta\lambda} \gamma^\alpha\gamma^\theta q^2
		-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\theta \gamma^\lambda \gamma^\beta q^2 \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\theta
		+M_T^2g^{\lambda\theta} \gamma^\alpha\gamma^\beta q^2
	...
	\begin{align}
		&\left[\slashed{P} (-\slashed{q} +M_T)\right]^4 \supset \bigg[\frac{4(1-\epsilon)}{(24 - 10\epsilon)}\gamma^\alpha \gamma^\beta\gamma^\lambda\gamma^\theta q^4
		-\frac{8}{(24 - 10\epsilon)}g^{\beta\theta} \gamma^\alpha \gamma^\lambda q^4 +\frac{2\epsilon}{(24 - 10\epsilon)}\gamma^\alpha \gamma^\beta\gamma^\theta\gamma^\lambda q^4
		\nonumber\\ &+ \frac{4\epsilon}{(24 - 10\epsilon)}g^{\beta\lambda}\gamma^\alpha \gamma^\theta q^4
		-2 \frac{(-2 + \epsilon)}{(24 - 10\epsilon)}\gamma^\alpha \gamma^\theta\gamma^\lambda\gamma^\beta q^4 + \frac{(-2 + \epsilon)\epsilon}{(24 - 10\epsilon)}\gamma^\alpha \gamma^\beta\gamma^\lambda\gamma^\theta q^4 \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\beta \gamma^\lambda\gamma^\theta  q^2 + M_T^2g^{\beta\lambda} \gamma^\alpha\gamma^\theta q^2
		-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\theta \gamma^\lambda \gamma^\beta q^2 \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\theta
		+M_T^2g^{\lambda\theta} \gamma^\alpha\gamma^\beta q^2
	...
	Expanding the terms around $\epsilon = 0$ and truncating at order $\epsilon$:
	
	\begin{align}
		&\left[\slashed{P} (-\slashed{q} +M_T)\right]^4 \supset \bigg[\left(\frac{1}{6} - \frac{7}{72}\epsilon\right)\gamma^\alpha \gamma^\beta\gamma^\lambda\gamma^\theta q^4
		-\left(\frac{1}{3} + \frac{5}{36}\epsilon\right)g^{\beta\theta} \gamma^\alpha \gamma^\lambda q^4 +\frac{\epsilon}{12}\gamma^\alpha \gamma^\beta\gamma^\theta\gamma^\lambda q^4
		\nonumber\\ &+ \frac{\epsilon}{6}g^{\beta\lambda}\gamma^\alpha \gamma^\theta q^4
		-\left(-\frac{1}{6} + \frac{1}{72}\epsilon\right)\gamma^\alpha \gamma^\theta\gamma^\lambda\gamma^\beta q^4 - \frac{\epsilon}{12}\gamma^\alpha \gamma^\beta\gamma^\lambda\gamma^\theta q^4 \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\beta \gamma^\lambda\gamma^\theta  q^2 + M_T^2g^{\beta\lambda} \gamma^\alpha\gamma^\theta q^2
		-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\theta \gamma^\lambda \gamma^\beta q^2 \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\theta
		+M_T^2g^{\lambda\theta} \gamma^\alpha\gamma^\beta q^2
	...
	\begin{align}
		&\left[\slashed{P} (-\slashed{q} +M_T)\right]^4 \supset \bigg[\left(\frac{1}{6} - \frac{7}{72}\epsilon\right)\gamma^\alpha \gamma^\beta\gamma^\lambda\gamma^\theta q^4
		-\left(\frac{1}{3} + \frac{5}{36}\epsilon\right)g^{\beta\theta} \gamma^\alpha \gamma^\lambda q^4 +\frac{\epsilon}{12}\gamma^\alpha \gamma^\beta\gamma^\lambda\gamma^\theta q^4
		\nonumber\\ &+ \frac{\epsilon}{6}g^{\beta\lambda}\gamma^\alpha \gamma^\theta q^4
		-\left(-\frac{1}{6} + \frac{1}{72}\epsilon\right)\gamma^\alpha \gamma^\theta\gamma^\lambda\gamma^\beta q^4 - \frac{\epsilon}{12}\gamma^\alpha \gamma^\beta\gamma^\lambda\gamma^\theta q^4 \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\beta \gamma^\lambda\gamma^\theta  q^2 + M_T^2g^{\beta\lambda} \gamma^\alpha\gamma^\theta q^2
		-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\theta \gamma^\lambda \gamma^\beta q^2 \nonumber\\
	...
	\begin{align}
		&\left[\slashed{P} (-\slashed{q} +M_T)\right]^4 \supset \bigg[\left(\frac{1}{6} - \frac{7}{72}\epsilon\right)\gamma^\alpha \gamma^\beta\gamma^\lambda\gamma^\theta q^4
		-\left(\frac{1}{3} + \frac{5}{36}\epsilon\right)g^{\beta\theta} \gamma^\alpha \gamma^\lambda q^4 
		\nonumber\\ &+ \frac{\epsilon}{6}g^{\beta\lambda}\gamma^\alpha \gamma^\theta q^4
		-\left(-\frac{1}{6} + \frac{1}{72}\epsilon\right)\gamma^\alpha \gamma^\theta\gamma^\lambda\gamma^\beta q^4  \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\beta \gamma^\lambda\gamma^\theta  q^2 + M_T^2g^{\beta\lambda} \gamma^\alpha\gamma^\theta q^2
		-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\theta \gamma^\lambda \gamma^\beta q^2 \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\theta
		+M_T^2g^{\lambda\theta} \gamma^\alpha\gamma^\beta q^2
	...
	\begin{align}
		...
		-\left(\frac{1}{3} + \frac{5}{36}\epsilon\right)g^{\beta\theta} \gamma^\alpha \gamma^\lambda q^4 
		\nonumber\\ &+ \frac{\epsilon}{6}g^{\beta\lambda}\gamma^\alpha \gamma^\theta q^4
		-\left(-\frac{1}{6} + \frac{1}{72}\epsilon\right)\gamma^\alpha (2 g^{\theta\lambda}\gamma^\beta - 2g^{\theta\beta}\gamma^\lambda + 2g^{\beta\lambda} \gamma^{\theta}- \gamma^\beta\gamma^\lambda \gamma^\theta) q^4  \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\beta \gamma^\lambda\gamma^\theta q^2 + M_T^2g^{\beta\lambda} \gamma^\alpha\gamma^\theta q^2
	...
	\begin{align}
		...
		-\left(\frac{1}{3} + \frac{5}{36}\epsilon\right)g^{\beta\theta} \gamma^\alpha \gamma^\lambda q^4 
		\nonumber\\ &+ \frac{\epsilon}{6}g^{\beta\lambda}\gamma^\alpha \gamma^\theta q^4
		-2\left(-\frac{1}{6} + \frac{1}{72}\epsilon\right) g^{\theta\lambda}\gamma^\alpha \gamma^\beta + 2\left(-\frac{1}{6} + \frac{1}{72}\epsilon\right)g^{\theta\beta}\gamma^{\alpha}\gamma^\lambda - 2\left(-\frac{1}{6} + \frac{1}{72}\epsilon\right)g^{\beta\lambda} \gamma^\alpha\gamma^{\theta} q^4  \nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha \gamma^\beta \gamma^\lambda\gamma^\theta q^2 + M_T^2g^{\beta\lambda} \gamma^\alpha\gamma^\theta q^2
		-\frac{1}{2}M_T^2 \gamma^\alpha(2 g^{\theta\lambda}\gamma^\beta - 2g^{\theta\beta}\gamma^\lambda + 2g^{\beta\lambda} \gamma^{\theta} - \gamma^\beta\gamma^\lambda \gamma^\theta) q^2\nonumber\\
		&-\frac{1}{2}M_T^2 \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\theta  q^2
		+M_T^2g^{\lambda\theta} \gamma^\alpha\gamma^\beta q^2
	...
	\begin{align}
		&\left[\slashed{P} (-\slashed{q} +M_T)\right]^4 \supset \bigg[
		-\left(\frac{2}{3} + \frac{1}{8}\epsilon\right)g^{\beta\theta} \gamma^\alpha \gamma^\lambda q^4 
		+\left(\frac{1}{3} - \frac{1}{36}\epsilon\right) g^{\theta\lambda}\gamma^\alpha \gamma^\beta  + \left(\frac{1}{3} + \frac{5}{36}\epsilon\right)g^{\beta\lambda} \gamma^\alpha\gamma^{\theta} q^4  \nonumber\\
		&+M_T^2 g^{\theta\beta}\gamma^\alpha\gamma^\lambda q^2 -M_T^2 \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\theta q^2 + M_T^4 \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\theta
		\bigg]P_\alpha P_\beta P_\lambda P_\theta
	\end{align}
	...
	\begin{align}
		...
		-\left(\frac{8}{3} + \frac{1}{2}\epsilon\right)g^{\beta\theta} g^{\alpha\lambda} q^4
		+ \left(\frac{4}{3} - \frac{1}{8}\epsilon\right)g^{\theta\lambda}g^{\alpha\beta}  q^4 + \left(\frac{4}{3} + \frac{5}{8}\epsilon\right)g^{\beta\lambda} g^{\alpha\theta} q^4+4M_T^2 g^{\theta\beta}g^{\alpha\lambda} q^2\nonumber\\
	...
	\begin{align}
		\tr\left[\slashed{P} (-\slashed{q} +M_T)\right]^4 &\supset \left[-\left(\frac{8}{3} + \frac{1}{2}\epsilon\right)q^4 +8M_T^2 q^2 - 4M_T^4\right]P^\mu P^\nu P_\mu P_\nu + \left[\left(\frac{4}{3} - \frac{1}{8}\epsilon\right)q^4 -4M_T^2 q^2+ 4M_T^4\right]P^\mu P_\mu P^\nu P_\nu\nonumber\\
		&+ \left[\left(\frac{4}{3} + \frac{5}{8}\epsilon\right)q^4 -4M_T^2 q^2+ 4M_T^4\right]P^\mu P^\nu P_\nu P_\mu
	\end{align}
