...
%	\end{align}
	...
	\begin{align}
		&\mathcal{L}^{\text{1-loop}}_{EFT,SF}[\phi_b,\psi_b] \supset \frac{1}{64\pi^2} y_{Hs} \tilde{\lf}^{1,0}_{s} h^2 -\frac{y_{DM}^2}{16\pi^2} \left(\frac{1}{4}\tilde{\lf}^{2,1,-1}_{T,s} - M_T^2 \tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t  \right) \nonumber\\
		...
		\nonumber\\&+ \frac{y_{DM}^2}{32\pi^2}\left(-\frac{1}{3}\tilde{\lf}^{4,1,-2}_{T,s}+M_T^2 \tilde{\lf}^{4,1,-1}_{T,s} - M_T^4 \tilde{\lf}^{4,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D_\mu D^2 t\right)
		\nonumber\\&+ \frac{y_{DM}^2}{32\pi^2}\left(-\frac{1}{3}\tilde{\lf}^{4,1,-2}_{T,s}+M_T^2 \tilde{\lf}^{4,1,-1}_{T,s} - M_T^4 \tilde{\lf}^{4,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D^2D_\mu t\right)
		\nonumber\\ &\frac{y_{DM}^2}{32\pi^2}\left(M_T^2\tilde{\lf}^{4,1,-1}_{T,s} - M_T^4\tilde{\lf}^{4,1,0}_{T,s}\right)\left(\bar{t} \, \Gamma^{\mu\nu\rho } \, P_R \, D_\mu D_\nu D_\rho t \right) - \begin{pmatrix}
			D_\mu ... D_\nu \to \overleftarrow{D}_\mu ... \overleftarrow{D}_{\nu}
		\end{pmatrix}
	\end{align}
	...
	\begin{align}
		&\mathcal{L}^{\text{1-loop}}_{EFT,SF}[\phi_b,\psi_b] \supset \frac{1}{64\pi^2} y_{Hs} \tilde{\lf}^{1,0}_{s} h^2 -\frac{y_{DM}^2}{16\pi^2} \left(-\frac{1}{4}\tilde{\lf}^{2,1,-1}_{T,s} + \frac{1}{2} \tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t  \right) \nonumber\\
		&+\frac{y_{DM}^2}{16\pi^2} \left(-\frac{1}{3}\tilde{\lf}^{4,1,-2}_{T,s} +  \tilde{\lf}^{2,1,0}_{T,s} \right)\left(\bar{t}\, \gamma^\mu \, P_R \, D_\nu D_\mu D_\nu t\right)
		\nonumber\\&+ \frac{y_{DM}^2}{16\pi^2}\left(-\frac{1}{6}\tilde{\lf}^{4,1,-2}_{T,s}+ \frac{1}{2}\tilde{\lf}^{3,1,-1}_{T,s} -  \frac{1}{2}\tilde{\lf}^{2,1,0}_{T,,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D_\mu D^2 t\right)
		\nonumber\\&+ \frac{y_{DM}^2}{16\pi^2}\left(-\frac{1}{6}\tilde{\lf}^{4,1,-2}_{T,s}+ \frac{1}{2}\tilde{\lf}^{3,1,-1}_{T,s} -  \frac{1}{2}\tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D^2D_\mu t\right)
		\nonumber\\ &\frac{y_{DM}^2}{16\pi^2}\left(\frac{1}{2}\tilde{\lf}^{3,1,-1}_{T,s} - \frac{1}{2}\tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t} \, \Gamma^{\mu\nu\rho } \, P_R \, D_\mu D_\nu D_\rho t \right) - \begin{pmatrix}
			D_\mu ... D_\nu \to \overleftarrow{D}_\mu ... \overleftarrow{D}_{\nu}
		\end{pmatrix}
	\end{align}
...
\subsubsection*{ $n=2$ contribution}
	...
	\begin{align}
		...
		&\supset -\frac{iy_{Hs}^2}{256\pi^2} \tilde{\lf}^{2,0}_{s} h^4-\frac{y_{DM}^2 y_{Hs}}{16\pi^2}\left(\frac{1}{8}\tilde{\lf}^{2,2,-1}_{T,s} -\frac{1}{4} M_T^2\tilde{\lf}^{2,2,0}_{T,s} \right)\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t\right) - \begin{pmatrix}
			D_\mu ... D_\nu \to \overleftarrow{D}_\mu ... \overleftarrow{D}_{\nu}
		\end{pmatrix}
	\end{align}
	...
	\begin{align}
		&\mathcal{L}^{\text{1-loop}}_{EFT,SF}[\phi_b,\psi_b] \supset -\frac{iy_{Hs}^2}{256\pi^2} \tilde{\lf}^{2,0}_{s} h^4-\frac{y_{DM}^2 y_{Hs}}{16\pi^2}\left(\frac{1}{8}\tilde{\lf}^{2,2,-1}_{T,s} -\frac{1}{4} \tilde{\lf}^{2,1,0}_{T,s} \right) h^2\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t\right) - \begin{pmatrix}
			D_\mu ... D_\nu \to \overleftarrow{D}_\mu ... \overleftarrow{D}_{\nu}
		\end{pmatrix}
	\end{align}
	...
	\subsubsection*{All one-loop contribution up to dimension six}
	
	We know that:
	
	\begin{align}
		\mathcal{L}^{\text{1-loop}}_{EFT}[\phi_b,\psi_b] = \mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] + \mathcal{L}^{\text{1-loop}}_{EFT,SF}[\phi_b,\psi_b]
	\end{align}
	
	Since $\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b]$ does not contributes:
	
	\begin{align}
		&\mathcal{L}^{\text{1-loop}}_{EFT}[\phi_b,\psi_b] \supset \frac{1}{64\pi^2} y_{Hs} \tilde{\lf}^{1,0}_{s} h^2 -\frac{y_{DM}^2}{16\pi^2} \left(-\frac{1}{4}\tilde{\lf}^{2,1,-1}_{T,s} + \frac{1}{2} \tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t  \right) \nonumber\\
		&+\frac{y_{DM}^2}{16\pi^2} \left(-\frac{1}{3}\tilde{\lf}^{4,1,-2}_{T,s} +  \tilde{\lf}^{2,1,0}_{T,s} \right)\left(\bar{t}\, \gamma^\mu \, P_R \, D_\nu D_\mu D_\nu t\right)
		\nonumber\\&+ \frac{y_{DM}^2}{16\pi^2}\left(-\frac{1}{6}\tilde{\lf}^{4,1,-2}_{T,s}+ \frac{1}{2}\tilde{\lf}^{3,1,-1}_{T,s} -  \frac{1}{2}\tilde{\lf}^{2,1,0}_{T,,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D_\mu D^2 t\right)
		\nonumber\\&+ \frac{y_{DM}^2}{16\pi^2}\left(-\frac{1}{6}\tilde{\lf}^{4,1,-2}_{T,s}+ \frac{1}{2}\tilde{\lf}^{3,1,-1}_{T,s} -  \frac{1}{2}\tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D^2D_\mu t\right)
		\nonumber\\ &\frac{y_{DM}^2}{16\pi^2}\left(\frac{1}{2}\tilde{\lf}^{3,1,-1}_{T,s} - \frac{1}{2}\tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t} \, \Gamma^{\mu\nu\rho } \, P_R \, D_\mu D_\nu D_\rho t \right) \nonumber\\
		&-\frac{iy_{Hs}^2}{256\pi^2} \tilde{\lf}^{2,0}_{s} h^4-\frac{y_{DM}^2 y_{Hs}}{16\pi^2}\left(\frac{1}{8}\tilde{\lf}^{2,2,-1}_{T,s} -\frac{1}{4} \tilde{\lf}^{2,1,0}_{T,s} \right)h^2\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t\right) 
		\nonumber\\&+ \frac{i}{12} y_{Hs}^2 \lf^{3,0}_{M_s}\, (h^3  P^2_s h + h^2 P_{s,\mu}h P_s^\mu h) - \frac{i}{48} y_{Hs}^3 \lf^{3,0}_{M_s}\, h^6 + \frac{i}{8} y_{Hs}^2 \lf^{1,-1}_{M_s}(h^3  P^2_s h + h^2 P_{s,\mu}h P_s^\mu h)\nonumber\\
		&\hspace{10cm}- \begin{pmatrix}
			D_\mu ... D_\nu \to \overleftarrow{D}_\mu ... \overleftarrow{D}_{\nu}
		\end{pmatrix}
	\end{align}
