...
\subsubsection*{ $n=2$ contribution}
	...
	\begin{itemize}
		...
		\begin{align}
			\tr A_2= q^2\bigg(& -\frac{3}{8} \, g^{\eta\omega} g^{\theta\tau} g^{\kappa\lambda}
			- \frac{3}{8} \, g^{\eta\tau} g^{\theta\omega} g^{\kappa\lambda}
			- \frac{3}{8} \, g^{\eta\omega} g^{\theta\lambda} g^{\kappa\tau}
			- \frac{3}{8} \, g^{\eta\lambda} g^{\theta\omega} g^{\kappa\tau}
			- \frac{3}{8} \, g^{\eta\tau} g^{\theta\lambda} g^{\kappa\omega} \nonumber\\
			& + \frac{3}{8} \, g^{\eta\lambda} g^{\theta\tau} g^{\kappa\omega}
			+ \frac{5}{8} \, g^{\eta\omega} g^{\theta\kappa} g^{\lambda\tau}
			+ \frac{5}{8} \, g^{\eta\kappa} g^{\theta\omega} g^{\lambda\tau}
			- \frac{5}{8} \, g^{\eta\theta} g^{\kappa\omega} g^{\lambda\tau}
			+ \frac{5}{8} \, g^{\eta\tau} g^{\theta\kappa} g^{\lambda\omega} \nonumber\\
			& - \frac{5}{8} \, g^{\eta\kappa} g^{\theta\tau} g^{\lambda\omega}
			+ \frac{5}{8} \, g^{\eta\theta} g^{\kappa\tau} g^{\lambda\omega}
			- \frac{5}{8} \, g^{\eta\lambda} g^{\theta\kappa} g^{\tau\omega}
			+ \frac{5}{8} \, g^{\eta\kappa} g^{\theta\lambda} g^{\tau\omega}
			+ \frac{5}{8} \, g^{\eta\theta} g^{\kappa\lambda} g^{\tau\omega}\bigg)P_\lambda P_\theta P_\omega P_\eta P_\tau P_\kappa
		\end{align}
		...
		\begin{align}
			...
			- 4\, g^{\eta\theta} g^{\kappa\lambda} g^{\tau\omega}  + 4\, g^{\eta\omega} g^{\theta\tau} g^{\kappa\lambda}
			+ 4\, g^{\eta\tau} g^{\theta\omega} g^{\kappa\lambda}
			+ 4\, g^{\eta\omega} g^{\theta\lambda} g^{\kappa\tau}
			\nonumber\\
			&+ 4\, g^{\eta\lambda} g^{\theta\omega} g^{\kappa\tau}
			+ 4\, g^{\eta\tau} g^{\theta\lambda} g^{\kappa\omega}
			- 4\, g^{\eta\lambda} g^{\theta\tau} g^{\kappa\omega}  - 4\, g^{\eta\omega} g^{\theta\kappa} g^{\lambda\tau}
			- 4\, g^{\eta\kappa} g^{\theta\omega} g^{\lambda\tau}
			+ 4\, g^{\eta\theta} g^{\kappa\omega} g^{\lambda\tau}
			\nonumber\\
			&- 4\, g^{\eta\tau} g^{\theta\kappa} g^{\lambda\omega}
			+ 4\, g^{\eta\kappa} g^{\theta\tau} g^{\lambda\omega}
			- 4\, g^{\eta\theta} g^{\kappa\tau} g^{\lambda\omega}  + 4\, g^{\eta\lambda} g^{\theta\kappa} g^{\tau\omega}
			- 4\, g^{\eta\kappa} g^{\theta\lambda} g^{\tau\omega}
			\nonumber\\
