...
%	\end{align}
	...
	\begin{align}
		\Delta_\psi^{-1}\tilde{\mathbf{X}}_{\psi\Psi} = \sum^{+\infty}_{n=0} \left[(-\slashed{q}-M_\psi)^{-1} \tilde{\id}\ccj^{-1} (-\ccj\tilde{\id}\slashed{P} - \tilde{\mathbf{X}}_{\psi\psi})\right]^{n}(-\slashed{q}-M_\psi)^{-1}\mathbf{X}_{\psi\Psi}\bigg\vert_{\text{hard}}, \ \ \ \mathbf{X}_{\psi\Psi} \equiv \tilde{\id}\ccj^{-1}\tilde{\mathbf{X}}_{\psi\Psi}
	\end{align}
	...
	\begin{itemize}
		...
		\begin{align}
			...
			&=\frac{(d-2)}{d}  \slashed{P}_{\Psi}q^2- M_T^2\slashed{P}_{\Psi}
		\end{align}
		Rewriting $d$ as $4-\epsilon$ and expanding up to order $\mathcal{O}(\epsilon)$:
		
		\begin{align}
			(-\slashed{q}+M_T)(-\slashed{P}_{\Psi} )(-\slashed{q}+ M_T) 
			&=\frac{(2 - \epsilon)}{4-\epsilon}  \slashed{P}_{\Psi}q^2- M_T^2\slashed{P}_{\Psi}\nonumber\\
		...
		\begin{align}
			...
			\end{pmatrix}  \frac{ (-\slashed{q}+M_T)(-\slashed{P}_{\Psi} )(-\slashed{q}+ M_T)}{(q^2-M_T^2)^{2}}\begin{pmatrix}
				t_R\\ \ccj^{-1}\bar{t}_R
			\end{pmatrix} &=i\frac{\left(\left(\frac{1}{2} - \frac{\epsilon}{8}\right) q^2- M_T^2\right)}{(q^2 - M_T^2)^2}\left[\bar{t}\, \gamma^\mu\, P_R\, D_\mu t - D_\mu \bar{t} \,\gamma^\mu\, P_R \, t \right]\label{eq:l=1}
 		\end{align}
 		...
 		Notice that the powers of $q$ that appears in this expression are $0$, $2$ and $4$. Recalling that the propagators in $n=1$ and $l=3$ are $(q^2- M_T^2)^4$ and $(q^2 - M_s^2)$, we can anticipate that the loop functions multiplying the operators will be $tilde{\lf}^{4,1,-2}_{T,s}$, $\tilde{\lf}^{4,1,-1}_{T,s}$ and $\tilde{\lf}^{4,1,0}_{T,s}$. Tehrefore, since all this loop functions are finite, we are already setting $d= 4$ once there is pole $\frac{1}{\epsilon}$ to cancel  with terms of $\mathcal{O}(\epsilon)$ and generate finite contributions.
	...
	\begin{align}
		&\mathcal{L}^{\text{1-loop}}_{EFT,SF}[\phi_b,\psi_b] \supset \frac{1}{64\pi^2} y_{Hs} \tilde{\lf}^{1,0}_{s} h^2 -i\frac{y_{DM}^2}{16\pi^2} \left(\left(\frac{1}{4} - \frac{\epsilon}{16}\right)\tilde{\lf}^{2,1,-1}_{T,s} - \frac{1}{2}M_T^2 \tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t - D_\mu\bar{t}\, \gamma^\mu\, P_R\,  t\right) \nonumber\\
	...
	\begin{align}
		\tilde{\lf}^{2,1,-1}_{T,s} = \frac{2}{\bar{\epsilon}} + \frac{M_S^2}{-M_T^2 + M_s^2} 
	...
	\begin{align}
		&\mathcal{L}^{\text{1-loop}}_{EFT,SF}[\phi_b,\psi_b] \supset \frac{1}{64\pi^2} y_{Hs} \tilde{\lf}^{1,0}_{s} h^2 -i\frac{y_{DM}^2}{16\pi^2} \left( - \frac{1}{8} + \frac{1}{4}\tilde{\lf}^{2,1,-1}_{T,s} - \frac{1}{2}M_T^2 \tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t - D_\mu\bar{t}\, \gamma^\mu\, P_R\,  t\right) \nonumber\\
		&-i\frac{y_{DM}^2}{32\pi^2} \left(\frac{2}{3}\tilde{\lf}^{4,1,-2}_{T,s} - 2M_T^2 \tilde{\lf}^{4,1,-1}_{T,s} + M_T^4 \tilde{\lf}^{4,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D_\nu D_\mu D_\nu t - D_\nu D_\mu D_\nu\bar{t}\, \gamma^\mu \, P_R \, t\right)
		\nonumber\\&-i \frac{y_{DM}^2}{32\pi^2}\left(-\frac{1}{3}\tilde{\lf}^{4,1,-2}_{T,s}+M_T^2 \tilde{\lf}^{4,1,-1}_{T,s} - M_T^4 \tilde{\lf}^{4,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D_\mu D^2 t - D_\mu D^2\bar{t}\, \gamma^\mu \, P_R \,  t\right)
		\nonumber\\&- i\frac{y_{DM}^2}{32\pi^2}\left(-\frac{1}{3}\tilde{\lf}^{4,1,-2}_{T,s}+M_T^2 \tilde{\lf}^{4,1,-1}_{T,s} - M_T^4 \tilde{\lf}^{4,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D^2D_\mu t - D^2D_\mu \bar{t}\, \gamma^\mu \, P_R \,  t \right)
		\nonumber\\ &-i\frac{y_{DM}^2}{32\pi^2}\left(M_T^2\tilde{\lf}^{4,1,-1}_{T,s} - M_T^4\tilde{\lf}^{4,1,0}_{T,s}\right)\left(\bar{t} \, \Gamma^{\mu\nu\rho } \, P_R \, D_\mu D_\nu D_\rho t -  D_\mu D_\nu D_\rho\bar{t} \, \Gamma^{\mu\nu\rho } \, P_R \, t \right) 
	...
	\begin{align}
		&\mathcal{L}^{\text{1-loop}}_{EFT,SF}[\phi_b,\psi_b] \supset \frac{1}{64\pi^2} y_{Hs} \tilde{\lf}^{1,0}_{s} h^2 +i\frac{y_{DM}^2}{16\pi^2} \left(\frac{1}{8} +  \frac{1}{2} \tilde{\lf}^{1,1,0}_{T,s}-\frac{1}{4}\tilde{\lf}^{2,1,-1}_{T,s}\right)\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t - D_\mu\bar{t}\, \gamma^\mu\, P_R\,  t\right) \nonumber\\
...
\subsubsection*{ $n=2$ contribution}
	...
	\begin{align}
		&\mathcal{L}^{\text{1-loop}}_{EFT}[\phi_b,\psi_b] \supset \frac{1}{64\pi^2} y_{Hs} \tilde{\lf}^{1,0}_{s} h^2 +i\frac{y_{DM}^2}{16\pi^2} \left( \frac{1}{8} +  \frac{1}{2} \tilde{\lf}^{1,1,0}_{T,s}-\frac{1}{4}\tilde{\lf}^{2,1,-1}_{T,s}\right)\left(\bar{t}\, \gamma^\mu\, P_R\, D_\mu t - D_\mu\bar{t}\, \gamma^\mu\, P_R\,  t\right) \nonumber\\
		&+i\frac{y_{DM}^2}{16\pi^2} \left(\frac{1}{6}\tilde{\lf}^{4,1,-2}_{T,s} - \frac{1}{2} \tilde{\lf}^{2,1,0}_{T,s} \right)\left(\bar{t}\, \gamma^\mu \, P_R \, D_\nu D_\mu D_\nu t - D_\nu D_\mu D_\nu\bar{t}\, \gamma^\mu \, P_R \, t\right)
		\nonumber\\&+ i\frac{y_{DM}^2}{16\pi^2}\left(\frac{1}{6}\tilde{\lf}^{4,1,-2}_{T,s}- \frac{1}{2}\tilde{\lf}^{3,1,-1}_{T,s} +  \frac{1}{2}\tilde{\lf}^{2,1,0}_{T,,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D_\mu D^2 t - D_\mu D^2\bar{t}\, \gamma^\mu \, P_R \,  t\right)
		\nonumber\\&+ i\frac{y_{DM}^2}{16\pi^2}\left(\frac{1}{6}\tilde{\lf}^{4,1,-2}_{T,s}- \frac{1}{2}\tilde{\lf}^{3,1,-1}_{T,s} +  \frac{1}{2}\tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t}\, \gamma^\mu \, P_R \, D^2D_\mu t - D^2D_\mu \bar{t}\, \gamma^\mu \, P_R \,  t \right)
		\nonumber\\ &+i\frac{y_{DM}^2}{16\pi^2}\left(-\frac{1}{2}\tilde{\lf}^{3,1,-1}_{T,s} + \frac{1}{2}\tilde{\lf}^{2,1,0}_{T,s}\right)\left(\bar{t} \, \Gamma^{\mu\nu\rho } \, P_R \, D_\mu D_\nu D_\rho t -  D_\mu D_\nu D_\rho\bar{t} \, \Gamma^{\mu\nu\rho } \, P_R \, t \right) \nonumber\\
	...
	\begin{align}
		\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] &= \frac{i}{2}\sum_{n=0}^{\infty}\frac{1}{n} \int \frac{d^d q}{(2\pi)^d}   \tr\left[ (-\slashed{q} - M_\Psi)^{-1}\left(-\slashed{P}  -\left( \mathbf{X}_{\Psi\Psi} - \mathbf{X}_{\Psi\psi}\Delta_\psi^{-1}\tilde{\mathbf{X}}_{\psi \Psi}\right)^{P\to P-q}\right) \right]^n_{\text{hard}} 
	\end{align}
	...
	\begin{align}
		\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] &= \frac{i}{2}\sum_{n=0}^{\infty}\frac{1}{n} \int \frac{d^d q}{(2\pi)^d}   \tr\left[ (-\slashed{q} - M_T)^{-1}(-\slashed{P})   \right]^n_{\text{hard}} = \frac{i}{2}\sum_{n=0}^{\infty}\frac{(-1)^n}{n} \int \frac{d^d q}{(2\pi)^d}   \tr\left[ \frac{ (-\slashed{q} +M_T)\slashed{P}   }{ q^2 - M_T^2 } \right]^n
	\end{align}
	...
	\begin{itemize}
		...
		\begin{align}
			\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] &=\frac{i}{4} \int \frac{d^d q}{(2\pi)^d}   \tr\left[ \frac{ (-\slashed{q} +M_T)\slashed{P}   }{ q^2 - M_T^2 } \right]\left[ \frac{(-\slashed{q} +M_T) \slashed{P}   }{ q^2 - M_T^2 } \right]
		\end{align}
		
		Since loop integrals with odd powers of $q$ vanishes:
		
		\begin{align}
			\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] &=\frac{i}{4} \int \frac{d^d q}{(2\pi)^d}   \tr\left[ \frac{ \slashed{q}\slashed{P}\slashed{q}\slashed{P} +M_T^2\slashed{P}\slashed{P})  }{ (q^2 - M_T^2)^2 } \right]
		\end{align}
		
		Using the substitution $q^\mu q^\nu \to \frac{g^{\mu\nu}}{4}q^2$ in the loop integral:
		
		\begin{align}
			\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] &=\frac{i}{4} \int \frac{d^d q}{(2\pi)^d}   \tr\left[\frac{ \frac{1}{4} \gamma^\rho \gamma^\mu\gamma_\rho\gamma^\nu P_\mu P_{\nu}q^2 +M_T^2\slashed{P}\slashed{P})  }{ (q^2 - M_T^2)^2 } \right]\nonumber\\
		...
		\begin{align}
			\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] &=\frac{i}{4} \int \frac{d^d q}{(2\pi)^d}   \tr\left[  \frac{ (-\slashed{q} +M_T)\slashed{P}  }{ q^2 - M_T^2 } \right]\left[ \frac{ (-\slashed{q} +M_T) \slashed{P}   }{ q^2 - M_T^2 } \right]\left[ \frac{ (-\slashed{q} +M_T) \slashed{P}   }{ q^2 - M_T^2 } \right]\left[ \frac{ (-\slashed{q} +M_T) \slashed{P}  }{ q^2 - M_T^2 } \right]\label{eq:B1}
		\end{align}
		
		Lets focus in the numerator first:
		
		\begin{align}
			\left[ (-\slashed{q} +M_T)\right]^4 &=  (-\slashed{q} +M_T)\slashed{P} (-\slashed{q} +M_T)\slashed{P} (-\slashed{q} +M_T)\slashed{P} (-\slashed{q} +M_T)\slashed{P}\nonumber\\
		...
		\noindent where we are discarding terms of $\mathcal{O}(\epsilon^2)$ or superior.
		...
		\begin{align}
			\left[ (-\slashed{q} +M_T)\slashed{P}\right]^4 &\supset \bigg[\frac{q^4 }{d(d+2)}\bigg(-6 \epsilon \gamma^\alpha\gamma^\beta\gamma^\lambda\gamma^\theta -4(4-\epsilon)g^{\alpha\lambda} \gamma^\beta\gamma^\theta ¨
		...
		\begin{align}
			\tr\left[ (-\slashed{q} +M_T)\slashed{P}\right]^4 &\supset \left[\left(-\frac{8}{3} + \frac{5}{9}\epsilon\right) q^4 + 8M_T^2 q^2 -4 M_T^4\right]P^\mu P^\nu P_\mu P_\nu\nonumber\\
		...
		\begin{align}
			&\tilde{\lf}^{4,-2}_T = -\frac{5}{6} + \frac{1}{\bar{\epsilon}} + \ln\left(\frac{\mu^2}{M_T^2}\right)\\
			&\tilde{\lf}^{4,-1} = -\frac{1}{3 M_T^2}\\
		...
		\begin{align}
			\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b]\supset& \frac{1}{24\pi^2}\left[\frac{1}{\bar{\epsilon}} +\ln\left(\frac{\mu^2}{M_T^2}\right) \right]\tr(P^\mu P^\nu P_\mu P_\nu)-\frac{1}{48\pi^2}\left[\frac{1}{\bar{\epsilon}} +\ln\left(\frac{\mu^2}{M_T^2}\right)\right]\tr\left(P^\mu P_\mu P^\nu P_\nu + P^\mu P^\nu P_\nu P_\mu \right)\nonumber\\
			\supset&\frac{1}{24\pi^2}\left[\frac{1}{\bar{\epsilon}} +\ln\left(\frac{\mu^2}{M_T^2}\right) \right]\tr(P^\mu P^\nu P_\mu P_\nu - P^\mu P^\nu P_\nu P_\mu)\nonumber\\
			\supset&\frac{1}{24\pi^2}\left[\frac{1}{\bar{\epsilon}} +\ln\left(\frac{\mu^2}{M_T^2}\right) \right](P^\mu P^\nu P_\mu P_\nu - P^\mu P^\nu P_\nu P_\mu)\nonumber\\
			\supset&\frac{1}{48\pi^2}\left[\frac{1}{\bar{\epsilon}} +\ln\left(\frac{\mu^2}{M_T^2}\right) \right]\tr([P^\mu, P^\nu][P_\mu, P_\nu])\nonumber\\
		\end{align}
		
		Using that $[P_\mu, P_\nu] = i g_s G_{\mu\nu}^a t^a_R$:
		
		\begin{align}
			\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b]\supset&-\frac{g_s^2}{48\pi^2}\left[\frac{1}{\bar{\epsilon}} +\ln\left(\frac{\mu^2}{M_T^2}\right) \right]G^a_{\mu\nu} G^{b\mu\nu}\tr(t^a_R t^b_R)
		\end{align}
		...
		\begin{align}
			\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b]\supset&-\frac{g_s^2}{96\pi^2}\left[\frac{1}{\bar{\epsilon}} +\ln\left(\frac{\mu^2}{M_T^2}\right) \right]G^a_{\mu\nu} G^{a\mu\nu}
		\end{align}
		...
		Notice that every term has an odd number of gamma matrices. Therefore, once we take the trace all terms will vanish:
		...
		\begin{align}
			...
			&\hspace{4.5cm}\left[ \frac{ (-\slashed{q} +M_T) \slashed{P}  }{ q^2 - M_T^2 } \right]\left[ \frac{ (-\slashed{q} +M_T) \slashed{P}  }{ q^2 - M_T^2 } \right]\left[ \frac{ (-\slashed{q} +M_T) \slashed{P}  }{ q^2 - M_T^2 } \right]
		\end{align}
		...
		\begin{align}
			...
			&+ M_T^6\slashed{P} \slashed{P}\slashed{P}\slashed{P}\slashed{P}\slashed{P}
		\end{align}
		
		
		Since there is a lot of terms, we are going to split this expression by defining:
		...
		By the powers of $q$ appearing in this expression and remembering that the denominator of the $n=6$ contribution is $1/(q^2-M_T^2)^6$, we know the terms above will generate loop functions $\tilde{\lf}^{6,-3}_T$, $\tilde{\lf}^{6,-2}_T$, $\tilde{\lf}^{6,-1}_T$ and $\tilde{\lf}^{6,0}_T$. Since this loop functions are finite, we do not need to worry about terms with $\mathcal{O}(\epsilon)$ contributions, and therefore, we can substitute $d=4$ now.
		
		To apply the substitutions of the loop integral calculations and compute the traces of this components above, we used Mathematica package X \cite{PackageX}\footnote{The notebook used for this calculation can be found in \href{https://github.com/viniciusrocca/EFT_ToyModel/blob/main/Dim6PureGauge.nb}{GitHub}}.
		...
		\begin{align}
			\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] = \frac{i}{16\pi^2}\tr\Bigg\{&\left[-\frac{4}{3} \tilde{\lf}^{6,-3}_T +6 M_T^4\tilde{\lf}^{6,-1}_T - 4 M_T^6 \tilde{\lf}^{6,0}_T\right]P^\mu P^\nu P^\rho P_\mu P_\nu P_\rho\nonumber\\
		...
		Using, commutation relations for the covariant derivatives, as done in \cite{Zhang_2017}, it is possible to write the expression above as:
		
		\begin{align}
			\mathcal{L}^{\text{1-loop}}_{EFT,F}[\phi_b,\psi_b] \supset \frac{i}{16\pi^2}\frac{1}{M_T^2}\Bigg\{&-\frac{2}{15}\tr(P^\mu P^\nu P^\rho P_\mu P_\nu P_\rho)
			+\frac{18}{5}\tr(P^\mu P^\nu P^\rho P_\mu P_\rho P_\nu) + \text{terms like } \tr(...P^2...)\Bigg\}
		\end{align}
		
		
		Recall that in a CDE expansion we can always write the final operators with every covariant derivative in commutators. For pure Gauge dimension six operators there is only two independent options\cite{Zhang_2017}:
		...
		As discussed in \textcolor{red}{mention the location of discussion}, we can match the coefficients of the expression 
	...
	\begin{align}
		&=\tr\{ P^\mu P_\mu P_\nu P_\rho P^\rho P^\nu - 2 P^\mu P^\nu P^\rho P_\nu P_\rho P_\mu + P^\mu P_\mu P_\nu  P^\nu P^\rho P_\rho\nonumber\\
		&-2 P^\mu P^\nu P^\rho P_\nu P_\rho P_\mu  + 4 P^\mu P^\nu P^\rho P_\mu P_\rho P_\nu  - 2 P^\mu P^\nu P^\rho P_\nu P_\rho P_\mu \nonumber\\
		& + P_\nu P_\mu P^\mu P_\rho P^\rho P^\nu - 2  P^\mu P^\nu P^\rho P_\nu P_\rho P_\mu+ P_\nu P_\mu P^\mu P^\nu P^\rho P_\rho\}\nonumber\\
	\end{align}
	...
	If we consider $\gamma_E \approx \frac{1}{2}$:
	
	\begin{align}
		\tilde{\lf}^{1,1,0}_{T,s}-\frac{1}{2}\tilde{\lf}^{2,1,-1}_{T,s} &=- \frac{1}{4} + \frac{1}{2}\frac{2}{\epsilon}  +\underbrace{  \frac{M_T^4\ln\left(\frac{\mu^2}{M_T^2}\right)}{2(M_T^2 - M_s^2)^2}+ \frac{(2M_T^2- M_s)}{2(M_T^2 - M_s^2)^2}\Bigg[ M_T^2 - M_s^2 -M_s^2 \ln\left(\frac{\mu^2}{M_s^2}\right) \Bigg]}_{\text{This is what EvaluateLoopFunctions return in Matchete}}
	\end{align}
