...
C --------------------
          ...
          if (mtt.gt.0.0d0) then
            if (mtt .lt. 2001.0d0) then
              polynomial_arg = - (1.3d-06 * mtt**2 - 6.0d-03 * mtt - 4.3d0)
              polynomial_offset =  -(1.3d-06 * mtt_bias_offset**2 - 6.0d-03 * mtt_bias_offset - 4.3d0)

            else if (mtt .ge. 2201.0d0 .and. mtt .lt. 2851.0d0) then
              polynomial_arg = - (- 2.2d-03 * mtt - 7.4d0)
              polynomial_offset = - (- 2.2d-03 * mtt_bias_offset - 7.4d0)


            else
              polynomial_arg = - (3.3d-07 * mtt**2 - 4.0d-03 * mtt - 4.5d0)
              polynomial_offset = - (3.3d-07 * mtt_bias_offset**2 - 4.0d-03 * mtt_bias_offset - 4.5d0)
          endif
