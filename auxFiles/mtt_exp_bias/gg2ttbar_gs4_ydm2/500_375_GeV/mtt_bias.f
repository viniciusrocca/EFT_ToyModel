...
C
          ...
          double precision, parameter :: bound_2 = 2050.0d0
...
c             Calculate the normalization offset using the first polynomial
              p_offset = 1.6933d-06*mtt_bias_offset**2
              p_offset = p_offset - 9.0223d-03*mtt_bias_offset
              p_offset = p_offset - 4.2367d-01
              p_offset = -p_offset
    
c             Pre-calculate the function values at each boundary
              p1_at_b1 = 1.6933d-06*bound_1**2 - 9.0223d-03*bound_1
              p1_at_b1 = p1_at_b1 - 4.2367d-01
              p1_at_b1 = -p1_at_b1
              
              p2_at_b1 = 7.8649d-07*bound_1**2 - 6.7196d-03*bound_1
              p2_at_b1 = p2_at_b1 - 1.8775d+00
              p2_at_b1 = -p2_at_b1
    
              p2_at_b2 = 7.8649d-07*bound_2**2 - 6.7196d-03*bound_2
              p2_at_b2 = p2_at_b2 - 1.8775d+00
              p2_at_b2 = -p2_at_b2
              
              p3_at_b2 = 1.6356d-07*bound_2**2 - 4.0479d-03*bound_2
              p3_at_b2 = p3_at_b2 - 4.7858d+00
              p3_at_b2 = -p3_at_b2
    
              p3_at_b3 = 1.6356d-07*bound_3**2 - 4.0479d-03*bound_3
              p3_at_b3 = p3_at_b3 - 4.7858d+00
              p3_at_b3 = -p3_at_b3
              
              p4_at_b3 = 1.3161d-06*bound_3**2 - 1.6430d-02*bound_3
              p4_at_b3 = p4_at_b3 + 2.7876d+01
              p4_at_b3 = -p4_at_b3

              if (mtt .lt. bound_1) then
c                 --- REGION 1 ---
                  p_val = 1.6933d-06*mtt**2 - 9.0223d-03*mtt 
     &                 - 4.2367d-01
                  p_val = -p_val
...
c                 --- REGION 2 ---
                  p_val = 7.8649d-07*mtt**2 - 6.7196d-03*mtt 
     &                 - 1.8775d+00
                  p_val = -p_val
...
c                 --- REGION 3 ---
		  mtt = min(4500.0d0, mtt)
                  p_val = 1.6356d-07*mtt**2 - 4.0479d-03*mtt 
     &                 - 4.7858d+00
                  p_val = -p_val
