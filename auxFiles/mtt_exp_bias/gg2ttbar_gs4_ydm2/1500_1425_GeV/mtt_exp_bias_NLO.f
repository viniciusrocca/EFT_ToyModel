...
c      double precision mtt_bias_enhancement_power
      ...
      if (mtt.gt.0.0d0) then
         if (mtt .lt. 1051.0d0) then
            ...
            polynomial_offset = - ( 1.5d-06 * 1800.0**2 - 8.5d-03 * 1800.0 - 2.9 )
            bias_wgt = EXP(polynomial_arg - polynomial_offset)
            
         else if (mtt .ge. 1051.0d0 .and. mtt .lt. 1851.0d0) then

c            polynomial_arg = - ( - 1.2d-06 * mtt**2 + 5.6d-03 * mtt - 2.3 )
c            polynomial_offset =  - ( 1.5d-06 * 1800.0**2 - 8.5d-03 * 1800.0 - 2.9 )
c            bias_wgt = EXP(polynomial_arg - polynomial_offset)
            polynomial_arg = - ( 1.5d-06 * mtt**2 - 7.9d-03 * mtt - 3.9 )
            polynomial_offset =  - ( 1.5d-06 * 1800.0**2 - 8.5d-03 * 1800.0 - 2.9 )
            bias_wgt = EXP(polynomial_arg - polynomial_offset)

         else if (mtt .ge. 1851.0d0 .and. mtt .lt. 2601.0d0) then

c            polynomial_arg = - ( - 1.2d-06 * mtt**2 + 5.6d-03 * mtt - 2.3 )
c            polynomial_offset =  - ( 1.5d-06 * 1800.0**2 - 8.5d-03 * 1800.0 - 2.9 )
c            bias_wgt = EXP(polynomial_arg - polynomial_offset)
            polynomial_arg = - (  1.3d-06 * mtt**2 - 8.0d-03 * mtt - 3.3 )
            polynomial_offset =  - ( 1.5d-06 * 1800.0**2 - 8.5d-03 * 1800.0 - 2.9 )
            bias_wgt = EXP(polynomial_arg - polynomial_offset)
