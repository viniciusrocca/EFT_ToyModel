...
c
      ...
      double precision, parameter :: bound_2 = 1601.0d0
      double precision, parameter :: bound_3 = 1801.0d0
...
c           --- REGION 2 (Stitched to Region 1) ---
            p_val = - ( - 8.6d-06 * mtt**2 + 1.3d-02 * mtt - 1.11d+01 )
            p1_at_b1 = - ( 5.0d-06 * bound_1**2 - 1.2d-02 * bound_1 + 0.2d0 )
            p2_at_b1 = - ( -8.6d-06 * bound_1**2 + 1.3d-02 * bound_1 - 1.11d+01 )
            bias_wgt = EXP(p_val + (p1_at_b1 - p2_at_b1) - p_offset)

         else if (mtt .lt. bound_3) then
c           --- REGION 3 (Stitched to Region 2) ---
            p_val = - ( - 1.6d-04 * mtt**2 + 5.4d-01 * mtt - 4.694d+02 )
            p2_at_b2 = - ( -8.6d-06 * bound_2**2 + 1.3d-02 * bound_2 - 1.11d+01 ) 
            p3_at_b2 = - ( - 1.6d-04 * bound_2**2 + 5.4d-01 * bound_2 - 4.694d+02 )
...
c           --- REGION 4 (Stitched to Region 3) ---
            p_val = - ( - 3.6d-07 * mtt**2 + 3.2d-05 * mtt - 10.5d0 )
            p3_at_b3 = - ( - 1.6d-04 * bound_3**2 + 5.4d-01 * bound_3 - 4.694d+02 )
            p4_at_b3 = - ( - 3.6d-07 * bound_3**2 + 3.2d-05 * bound_3 - 10.5d0 )
