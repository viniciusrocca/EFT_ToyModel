...
c           --- REGION 2 (Stitched to Region 1) ---
            p_val = - ( -7.8d-06 * mtt**2 + 1.1d-02 * mtt - 9.9d0 )
            p1_at_b1 = - ( 5.0d-06 * bound_1**2 - 1.2d-02 * bound_1 + 0.2d0 )
            p2_at_b1 = - ( -7.8d-06 * bound_1**2 + 1.1d-02 * bound_1 - 9.9d0 )
            bias_wgt = EXP(p_val + (p1_at_b1 - p2_at_b1) - p_offset)

         else if (mtt .lt. bound_3) then
c           --- REGION 3 (Stitched to Region 2) ---
            p_val = - ( 5.8d-05 * mtt**2 - 2.0d-01 * mtt + 1.5293d+02 )
            p2_at_b2 = - ( -7.8d-06 * bound_2**2 + 1.1d-02 * bound_2 - 9.9d0 ) 
            p3_at_b2 = - ( 5.8d-05 * bound_2**2 - 2.0d-01 * bound_2 + 1.5293d+02 )
...
c           --- REGION 4 (Stitched to Region 3) ---
            ...
            p3_at_b3 = - ( 5.8d-05 * bound_3**2 - 2.0d-01 * bound_3 + 1.5293d+02 )
...
c           --- REGION 5 (Stitched to Region 4) ---
	    mtt = min(mtt,4000.0)
            ...
            p4_at_b4 = - ( -1.4d-06 * bound_4**2 + 5.1d-03 * bound_4 - 16.5d0 )
