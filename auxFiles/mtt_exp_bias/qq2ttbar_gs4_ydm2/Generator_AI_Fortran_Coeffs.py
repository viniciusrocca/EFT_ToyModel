...
data_db = {
    ...
    (1500, 1425): np.concatenate([
        [-2.06487133e-10, 1.65072671e-06, -6.01636387e-03, -4.49070711e+00],
        [-5.19703968e-06, 3.05754916e-02, -5.78070078e+01],
        [-1.37827437e-09, 1.47525080e-05, -5.62911292e-02, 6.07833974e+01],
        [2.08217545e-04, -1.95085764e+00, 4.54642936e+03],
        [6.31961993e-10, -1.14968982e-05, 6.76725667e-02, -1.50020346e+02]
    ]),
    (725, 675): np.concatenate([
        [3.56949962e-11, 1.86036127e-06, -6.48783136e-03, -2.80379538e+00],
        [-3.66915916e-05, 1.05484164e-01, -8.37199776e+01],
        [-1.38083045e-08, 7.29203858e-05, -1.34423253e-01, 7.62990117e+01],
        [4.93901208e-05, -2.18831485e-01, 2.26999685e+02],
        [5.96796474e-10, -6.41566734e-06, 2.07459830e-02, -3.42598704e+01]
    ]),
    (1000, 500): np.concatenate([
        [-2.39639896e-10, 2.13592580e-06, -6.68913248e-03, -3.13936659e+00],
        [-1.61414323e-05, 6.36849791e-02, -7.24061072e+01],
    ...
    (600, 475): np.concatenate([
        ...
        [-4.45985532e-05, 1.05816666e-01, -6.94943071e+01],
    ...
    (800, 760): np.concatenate([
        ...
        [-3.43338437e-05, 1.09105054e-01, -9.51693159e+01],
        [-9.75619695e-09, 5.66701694e-05, -1.15286766e-01, 7.13018064e+01],
        [-4.11998766e-05, 2.21564406e-01, -3.12655753e+02],
    ...
    (500, 375): np.concatenate([
        ...
        [-6.18215157e-06, 1.32425962e-02, -1.28114298e+01],
...
data_db = {
    (500, 475): np.concatenate([
        [ 8.17090128e-09, -1.27767291e-05,  2.52870776e-03, -3.83718275e+00],
        [-4.99086469e-05,  9.81138370e-02, -5.40743930e+01],
        [-5.96732731e-06,  5.76629307e-03, -5.65420921e+00],
        [ 1.38828455e-04, -4.39004622e-01,  3.35157207e+02],
        [ 5.37484251e-10, -4.51818032e-06,  1.01946846e-02, -1.75026919e+01]
    ]),
    (1500, 1425): np.concatenate([
        [-2.17233376e-10,  1.69643662e-06, -6.07376512e-03, -4.47024740e+00],
        [-5.13871783e-06,  2.97886105e-02, -5.59935826e+01],
        [-1.04892900e-06,  3.71127046e-03, -1.46748151e+01],
        [ 1.79661682e-04, -1.68186142e+00,  3.91402106e+03],
        [ 5.99684476e-10, -1.09605150e-05,  6.47131074e-02, -1.44598815e+02]
    ]),
    (725, 675): np.concatenate([
        [ 3.56949962e-11,  1.86036127e-06, -6.48783136e-03, -2.80379538e+00],
        [-3.13262874e-05,  9.00320878e-02, -7.26091033e+01],
        [-3.81025449e-06,  7.09067612e-03, -1.03214552e+01],
        [ 1.22281161e-04, -5.55588088e-01,  6.16554934e+02],
        [ 5.96796474e-10, -6.41566734e-06,  2.07459830e-02, -3.42598704e+01]
    ]),
    (1000, 500): np.concatenate([
        [-2.39639896e-10,  2.13592580e-06, -6.68913248e-03, -3.13936659e+00],
        [-1.99476941e-05,  7.86055252e-02, -8.70121609e+01],
        [-3.15389278e-06,  9.27288118e-03, -1.56274650e+01],
        [ 1.39856463e-04, -8.17995411e-01,  1.17971641e+03],
        [ 4.31131638e-10, -5.72620222e-06,  2.31449820e-02, -4.44064079e+01]
    ]),
    (600, 475): np.concatenate([
        [ 2.91994336e-09, -4.08694504e-06, -2.32058351e-03, -3.25148628e+00],
        [-3.89076543e-05,  9.22723265e-02, -6.14509327e+01],
        [-7.98607570e-06,  1.56327393e-02, -1.42816371e+01],
        [ 2.19057869e-04, -8.05170660e-01,  7.26641744e+02],
        [ 5.32417398e-10, -4.98901121e-06,  1.32005565e-02, -2.22211670e+01]
    ]),
    (800, 760): np.concatenate([
        [-6.21576760e-11,  2.11367983e-06, -6.86059526e-03, -2.88636391e+00],
        [-2.98277738e-05,  9.47757513e-02, -8.37897997e+01],
        [-3.29760610e-06,  6.98489167e-03, -1.13950197e+01],
        [ 1.08792636e-04, -5.46397258e-01,  6.70726447e+02],
        [ 3.78231138e-10, -4.66367169e-06,  1.68276211e-02, -3.28200711e+01]
    ]),
    (500, 375): np.concatenate([
        [ 5.59559214e-09, -7.96073190e-06, -3.59280517e-04, -3.15459439e+00],
        [-5.17799120e-05,  1.01702252e-01, -5.56448261e+01],
        [-7.94576310e-06,  9.88983249e-03, -7.70577901e+00],
        [ 1.28355987e-04, -3.92519482e-01,  2.88682520e+02],
        [ 4.98284614e-10, -4.09118288e-06,  8.67347408e-03, -1.55891064e+01]
    ])
}
