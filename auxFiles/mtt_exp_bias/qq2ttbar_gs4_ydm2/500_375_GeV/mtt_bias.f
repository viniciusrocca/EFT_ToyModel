...
C
          double precision, parameter :: bound_1 = 1450.0d0
          double precision, parameter :: bound_2 = 3300.0d0
          double precision, parameter :: bound_3 = 4500.0d0
...
c             Calculate the normalization offset using the first polynomial
              p_offset = 1.2592d-06*mtt_bias_offset**2
              p_offset = p_offset - 5.9458d-03*mtt_bias_offset
              p_offset = p_offset - 2.1504d+00
              p_offset = -p_offset
    
c             Pre-calculate the function values at each boundary
              p1_at_b1 = 1.2592d-06*bound_1**2 - 5.9458d-03*bound_1
              p1_at_b1 = p1_at_b1 - 2.1504d+00
              p1_at_b1 = -p1_at_b1
              
              p2_at_b1 = 1.4094d-07*bound_1**2 - 2.8498d-03*bound_1
              p2_at_b1 = p2_at_b1 - 4.3602d+00
              p2_at_b1 = -p2_at_b1
    
              p2_at_b2 = 1.4094d-07*bound_2**2 - 2.8498d-03*bound_2
              p2_at_b2 = p2_at_b2 - 4.3602d+00
              p2_at_b2 = -p2_at_b2
              
              p3_at_b2 = -1.7687d-08*bound_2**2 - 1.8587d-03*bound_2
              p3_at_b2 = p3_at_b2 - 5.9346d+00
              p3_at_b2 = -p3_at_b2
    
              p3_at_b3 = -1.7687d-08*bound_3**2 - 1.8587d-03*bound_3
              p3_at_b3 = p3_at_b3 - 5.9346d+00
              p3_at_b3 = -p3_at_b3
              
              p4_at_b3 = 8.8187d-09*bound_3**2 - 2.2170d-03*bound_3
              p4_at_b3 = p4_at_b3 - 4.8427d+00
              p4_at_b3 = -p4_at_b3

              if (mtt .lt. bound_1) then
c                 --- REGION 1 ---
                  p_val = 1.2592d-06*mtt**2 - 5.9458d-03*mtt 
     &                 - 2.1504d+00
                  p_val = -p_val
...
c                 --- REGION 2 ---
                  p_val = 1.4094d-07*mtt**2 - 2.8498d-03*mtt 
     &                 - 4.3602d+00
                  p_val = -p_val
...
c                 --- REGION 3 ---
                  p_val = -1.7687d-08*mtt**2 - 1.8587d-03*mtt 
     &                 - 5.9346d+00
                  p_val = -p_val
...
c                 --- REGION 4 ---
                  ...
                  p_val = 8.8187d-09*mtt**2 - 2.2170d-03*mtt 
     &                 - 4.8427d+00
                  p_val = -p_val
                  stitch_sum = (p1_at_b1 - p2_at_b1) + (p2_at_b2 - p3_at_b2)
