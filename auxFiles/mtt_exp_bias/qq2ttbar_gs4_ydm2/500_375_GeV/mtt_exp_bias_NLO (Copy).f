...
c --- Boundary and Normalization Parameters ---
      ...
      double precision, parameter :: mtt_norm = 1200.0d0
...
c             Calculate the normalization offset using the first polynomial
              p_offset = 3.6068d-06*mtt_norm**2
              p_offset = p_offset - 1.0894d-02*mtt_norm
              p_offset = p_offset - 3.5622d+00
              p_offset = -p_offset
    
c             Pre-calculate the function values at each boundary
              p1_at_b1 = 3.6068d-06*bound_1**2 - 1.0894d-02*bound_1
              p1_at_b1 = p1_at_b1 - 3.5622d+00
              p1_at_b1 = -p1_at_b1
              
              p2_at_b1 = 2.0949d-05*bound_1**2 - 3.8565d-02*bound_1
              p2_at_b1 = p2_at_b1 + 7.5355d+00
              p2_at_b1 = -p2_at_b1
    
              p2_at_b2 = 2.0949d-05*bound_2**2 - 3.8565d-02*bound_2
              p2_at_b2 = p2_at_b2 + 7.5355d+00
              p2_at_b2 = -p2_at_b2
              ...
              p5_at_b4 = -1.3789d-06*bound_4**2 + 2.4802d-03*bound_4
              p5_at_b4 = p5_at_b4 - 1.7672d+01
              p5_at_b4 = -p5_at_b4
    
              p5_at_b5 = -1.3789d-06*bound_5**2 + 2.4802d-03*bound_5
              p5_at_b5 = p5_at_b5 - 1.7672d+01
              p5_at_b5 = -p5_at_b5
...
c                 --- REGION 1 ---
                  p_val = 3.6068d-06*mtt**2 - 1.0894d-02*mtt 
     &                 - 3.5622d+00
                  p_val = -p_val
...
c                 --- REGION 2 ---
                  p_val = 2.0949d-05*mtt**2 - 3.8565d-02*mtt 
     &                 + 7.5355d+00
                  p_val = -p_val
...
c                 --- REGION 4 ---
     ...
     &                 + 1.5563d+02
                  ...
                  final_arg = p_val + stitch_sum - p_offset +0.62 + 1.04
        
              else if (mtt .lt. bound_5) then
c                 --- REGION 5 ---
                  p_val = -1.3789d-06*mtt**2 + 2.4802d-03*mtt 
     &                 - 1.7672d+01
                  p_val = -p_val
                  stitch_sum = (p1_at_b1 - p2_at_b1) + (p2_at_b2 - p3_at_b2)
                  stitch_sum = stitch_sum + (p3_at_b3 - p4_at_b3)
                  stitch_sum = stitch_sum + (p4_at_b4 - p5_at_b4)
                  final_arg = p_val + stitch_sum - p_offset + 0.92 + 0.69 + 0.69
...
c                 --- REGION 6 ---
     ...
     &                 - 6.4077d+00
                  ...
                  final_arg = p_val + stitch_sum - p_offset + 1.6 + 1.1 +0.69
