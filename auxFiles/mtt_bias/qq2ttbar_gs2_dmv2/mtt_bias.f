...
C --------------------
          ...
          if (mtt.gt.0.0d0) then
            if (mtt .lt. 1250.0d0) then
              ! Region 1 (Quadratic)
              polynomial_arg = - (1.11618361d-06 * mtt**2 - 5.18977661d-03 * mtt - 3.42780624d+01)
              ! Offset calculated using Region 2 coefficients
              polynomial_offset =  - (-3.09606745d-06 * mtt_bias_offset**2 + 6.34230243d-03 * mtt_bias_offset - 4.21323122d+01)

            else if (mtt .ge. 1250.0d0 .and. mtt .lt. 1850.0d0) then
              ! Region 2 (Quadratic)
              polynomial_arg = - (-3.09606745d-06 * mtt**2 + 6.34230243d-03 * mtt - 4.21323122d+01)
              polynomial_offset =  - (-3.09606745d-06 * mtt_bias_offset**2 + 6.34230243d-03 * mtt_bias_offset - 4.21323122d+01)

            else if (mtt .ge. 1850.0d0 .and. mtt .lt. 2150.0d0) then
              ! Region 3 (Cubic)
              polynomial_arg = - (1.02450838d-07 * mtt**3 - 5.15112269d-04 * mtt**2 + 8.27613974d-01 * mtt - 4.57405346d+02)
              polynomial_offset =  - (-3.09606745d-06 * mtt_bias_offset**2 + 6.34230243d-03 * mtt_bias_offset - 4.21323122d+01)

            else if (mtt .ge. 2150.0d0 .and. mtt .lt. 3100.0d0) then
              ! Region 4 (Quadratic)
              polynomial_arg = - (-1.61086829d-06 * mtt**2 + 6.07140998d-03 * mtt - 4.70317996d+01)
              polynomial_offset =  - (-3.09606745d-06 * mtt_bias_offset**2 + 6.34230243d-03 * mtt_bias_offset - 4.21323122d+01)

            else if (mtt .ge. 3100.0d0 .and. mtt .lt. 4500.0d0) then
              ! Region 5 (Quadratic)
              polynomial_arg = - (8.90348842d-08 * mtt**2 - 3.34016894d-03 * mtt - 3.40959541d+01)
              polynomial_offset =  - (-3.09606745d-06 * mtt_bias_offset**2 + 6.34230243d-03 * mtt_bias_offset - 4.21323122d+01)

            else
            ! Region 6 (Quadratic)
            mtt = min(mtt, 6000.0d0)
              polynomial_arg = - (-7.78017230d-08 * mtt**2 - 1.71834982d-03 * mtt - 3.80530270d+01)
              polynomial_offset =  - (-3.09606745d-06 * mtt_bias_offset**2 + 6.34230243d-03 * mtt_bias_offset - 4.21323122d+01)
          endif
