...
Decay_H = Decay(name = 'Decay_H',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-12*MB**2*yb**2 + 3*MH**2*yb**2)*cmath.sqrt(-4*MB**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.P__tilde__SDM,P.P__tilde__SDM):'(lamHs**2*vev**2*cmath.sqrt(MH**4 - 4*MH**2*mSDM**2))/(128.*cmath.pi*abs(MH)**3)',
...
Decay_psiT = Decay(name = 'Decay_psiT',
                   particle = P.psiT,
                   partial_widths = {(P.P__tilde__SDM,P.t):'((3*mPsiT**2*yDM**2 - 3*mSDM**2*yDM**2 + 3*MT**2*yDM**2)*cmath.sqrt(mPsiT**4 - 2*mPsiT**2*mSDM**2 + mSDM**4 - 2*mPsiT**2*MT**2 - 2*mSDM**2*MT**2 + MT**4))/(96.*cmath.pi*abs(mPsiT)**3)'})

Decay_P__tilde__SDM = Decay(name = 'Decay_P__tilde__SDM',
                            particle = P.P__tilde__SDM,
                            partial_widths = {(P.psiT,P.t__tilde__):'((-3*mPsiT**2*yDM**2 + 3*mSDM**2*yDM**2 - 3*MT**2*yDM**2)*cmath.sqrt(mPsiT**4 - 2*mPsiT**2*mSDM**2 + mSDM**4 - 2*mPsiT**2*MT**2 - 2*mSDM**2*MT**2 + MT**4))/(16.*cmath.pi*abs(mSDM)**3)',
                                              (P.t,P.psiT__tilde__):'((-3*mPsiT**2*yDM**2 + 3*mSDM**2*yDM**2 - 3*MT**2*yDM**2)*cmath.sqrt(mPsiT**4 - 2*mPsiT**2*mSDM**2 + mSDM**4 - 2*mPsiT**2*MT**2 - 2*mSDM**2*MT**2 + MT**4))/(16.*cmath.pi*abs(mSDM)**3)'})

Decay_t = Decay(name = 'Decay_t',
                particle = P.t,
                partial_widths = {(P.P__tilde__SDM,P.psiT):'((3*mPsiT**2*yDM**2 - 3*mSDM**2*yDM**2 + 3*MT**2*yDM**2)*cmath.sqrt(mPsiT**4 - 2*mPsiT**2*mSDM**2 + mSDM**4 - 2*mPsiT**2*MT**2 - 2*mSDM**2*MT**2 + MT**4))/(96.*cmath.pi*abs(MT)**3)',
