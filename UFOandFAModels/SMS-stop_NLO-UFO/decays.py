...
Decay_P__tilde__chi = Decay(name = 'Decay_P__tilde__chi',
                            ...
                            partial_widths = {(P.P__tilde__ST,P.t__tilde__):'((3*mChi**2*yDM**2 - 3*mST**2*yDM**2 + 3*MT**2*yDM**2)*cmath.sqrt(mChi**4 - 2*mChi**2*mST**2 + mST**4 - 2*mChi**2*MT**2 - 2*mST**2*MT**2 + MT**4))/(32.*cmath.pi*abs(mChi)**3)',
                                              (P.P__tilde__ST__tilde__,P.t):'((3*mChi**2*yDM**2 - 3*mST**2*yDM**2 + 3*MT**2*yDM**2)*cmath.sqrt(mChi**4 - 2*mChi**2*mST**2 + mST**4 - 2*mChi**2*MT**2 - 2*mST**2*MT**2 + MT**4))/(32.*cmath.pi*abs(mChi)**3)'})
